...
from models.transformer_networks import GPT2, GPT3, LLaMA
...
models = {
    ...
    'LLaMA-1': LLaMA(vocab_size=vocab_size, context_size=context_size, embed_size=384, hidden_size=4*384, n_layers=6, attn_heads=6),
}
