...
- MatrixFactorization
- AutoencoderLinear
- Word2Vec <sup>[*[19]*](#ref19 "Efficient Estimation of Word Representations in Vector Space")</sup>
...
- AdaDelta
- Adam
- AdamW <sup>[*[20]*](#ref20 "Decoupled Weight Decay Regularization")</sup>
- LR_Scheduler
- LR_StepScheduler
- LR_PlateauScheduler
...
- Encoder
- Decoder
- Seq2Seq <sup>[*[21]*](#ref21 "Sequence to Sequence Learning with Neural Networks")</sup>

`models.convolutional_networks` [➜](src/models/convolutional_networks.py)
- SimpleCNN
- SimpleFullyCNN
- LeNet5 <sup>[*[22]*](#ref22 "Gradient-based learning applied to document recognition")</sup>
- AlexNet <sup>[*[4]*](#ref4 "ImageNet Classification with Deep Convolutional Neural Networks")</sup>
- NetworkInNetwork <sup>[*[23]*](#ref23 "Network In Network")</sup>
- VGG16 <sup>[*[24]*](#ref24 "Very Deep Convolutional Networks for Large-Scale Image Recognition")</sup>
- GoogLeNet <sup>[*[25]*](#ref25 "Going deeper with convolutions")</sup>
- DeepPlainCNN

`models.residual_networks` [➜](src/models/residual_networks.py)
- ResNet34 <sup>[*[26]*](#ref26 "Deep Residual Learning for Image Recognition")</sup>
- ResNet50 <sup>[*[26]*](#ref26 "Deep Residual Learning for Image Recognition")</sup>
- ResNeXt50 <sup>[*[27]*](#ref27 "Aggregated Residual Transformations for Deep Neural Networks")</sup>
- SEResNet50 <sup>[*[28]*](#ref28 "Squeeze-and-Excitation Networks")</sup>
- SEResNeXt50 <sup>[*[28]*](#ref28 "Squeeze-and-Excitation Networks")</sup>
- DenseNet121 <sup>[*[29]*](#ref29 "Densely Connected Convolutional Networks")</sup>
...
- GIN <sup>[*[30]*](#ref30 "How Powerful are Graph Neural Networks?")</sup>
...
- RecurrentAttention <sup>[*[31]*](#ref31 "Recurrent Models of Visual Attention")</sup>
- SpatialTransformer <sup>[*[32]*](#ref32 "Spatial Transformer Networks")</sup>
...
- GPT_TransformerBlock <sup>[*[33]*](#ref33 "Language Models are Unsupervised Multitask Learners")</sup>
- GPT_SparseTransformerBlock <sup>[*[15]*](#ref15 "Generating Long Sequences with Sparse Transformers")</sup>
- GPT2 <sup>[*[33]*](#ref33 "Language Models are Unsupervised Multitask Learners")</sup>
...
- ResBlock <sup>[*[26]*](#ref26 "Deep Residual Learning for Image Recognition")</sup>
- ResBottleneckBlock <sup>[*[26]*](#ref26 "Deep Residual Learning for Image Recognition")</sup>
- ResNeXtBlock <sup>[*[27]*](#ref27 "Aggregated Residual Transformations for Deep Neural Networks")</sup>
- DenseLayer <sup>[*[29]*](#ref29 "Densely Connected Convolutional Networks")</sup>
- DenseBlock <sup>[*[29]*](#ref29 "Densely Connected Convolutional Networks")</sup>
- DenseTransition <sup>[*[29]*](#ref29 "Densely Connected Convolutional Networks")</sup>
...
19. <a name="ref19" href="https://arxiv.org/pdf/1301.3781.pdf">Efficient Estimation of Word Representations in Vector Space</a>
20. <a name="ref20" href="https://arxiv.org/pdf/1711.05101">Decoupled Weight Decay Regularization</a>
21. <a name="ref21" href="https://papers.nips.cc/paper/2014/file/a14ac55a4f27472c5d894ec1c3c743d2-Paper.pdf">Sequence to Sequence Learning with Neural Networks</a>
22. <a name="ref22" href="https://hal.science/hal-03926082/document">Gradient-based learning applied to document recognition</a>
23. <a name="ref23" href="https://arxiv.org/pdf/1312.4400.pdf">Network In Network</a>
24. <a name="ref24" href="https://arxiv.org/pdf/1409.1556.pdf">Very Deep Convolutional Networks for Large-Scale Image Recognition</a>
25. <a name="ref25" href="https://arxiv.org/pdf/1409.4842.pdf?">Going deeper with convolutions</a>
26. <a name="ref26" href="https://arxiv.org/pdf/1512.03385.pdf">Deep Residual Learning for Image Recognition</a>
27. <a name="ref27" href="https://openaccess.thecvf.com/content_cvpr_2017/papers/Xie_Aggregated_Residual_Transformations_CVPR_2017_paper.pdf">Aggregated Residual Transformations for Deep Neural Networks</a>
28. <a name="ref28" href="https://arxiv.org/pdf/1709.01507.pdf">Squeeze-and-Excitation Networks</a>
29. <a name="ref29" href="https://openaccess.thecvf.com/content_cvpr_2017/papers/Huang_Densely_Connected_Convolutional_CVPR_2017_paper.pdf">Densely Connected Convolutional Networks</a>
30. <a name="ref30" href="https://arxiv.org/pdf/1810.00826v3.pdf">How Powerful are Graph Neural Networks?</a>
31. <a name="ref31" href="https://arxiv.org/pdf/1406.6247.pdf">Recurrent Models of Visual Attention</a>
32. <a name="ref32" href="https://arxiv.org/pdf/1506.02025.pdf">Spatial Transformer Networks</a>
