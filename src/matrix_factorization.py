...
ax2.matshow(R_hat[users, animes].todense().T, aspect='auto', cmap='Greens'); ax2.set_title('Ratings (predicted)'); ax2.set_xlabel('Users')
ax3.matshow(R_hat_full.T, aspect='auto', cmap='Greens');  ax3.set_title('Ratings (predicted & extrapolated)'); ax3.set_xlabel('Users')
